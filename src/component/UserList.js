...
function UserList() {
    ...
    const getUsers = async () => {
        let response = await axios.get(`${URL}/user/get-users`)
    ...
    const deleteUserById = async (id) => {
       ...
       let response= await axios.delete(`${URL}/user/remove-user/${id}`)
    ...
    const saveUserById = async (modifiedUser) => {
      let response=  await axios.put(`${URL}/user/update-user`, modifiedUser)
